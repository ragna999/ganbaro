          ...
          {imageSrc && (
            <div className="flex flex-wrap gap-2 sm:gap-3">
              <button
                ...
                disabled={processing}
                className="flex-1 min-w-[120px] py-2.5 rounded-lg bg-zinc-700 hover:bg-zinc-600 disabled:opacity-50 text-zinc-100 text-sm font-medium transition-colors"
              >
              ...
              <button
                ...
                className="flex-1 min-w-[120px] py-2.5 rounded-lg bg-violet-600 hover:bg-violet-500 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-medium transition-colors"
              >
                Download .{format}
              </button>
            </div>
